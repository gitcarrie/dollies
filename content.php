...
elseif($tab == 'auditions') {
	echo '<p align="center"><span class="title">2013-2014 Dollie Auditions</span><br></p>';//<br> and General Audition Information!
	if($auditionseason == false) {
		echo
			'<div class="futurecontent">2013-2014 Stanford Dollie Auditions begin early next year!
				Please check back for updates in January of 2012 for audition dates and workshop schedules. 
	...
	if($auditionseason == true) {
		echo 
			'<div class="futurecontent">Auditions for the 2013-2014 Season will take place in January/February!  
...
*/		
	...
	echo '<div class="futurecontent2">
			 <ul class="futureinfolist"><span class="boldtext">Interested in the 2013-2014 Stanford Dollie Auditions? </span>
...
// ***********************************************  DOLLIE YEAR MAIN CONTENT PAGE *********************************
	...
	echo '<div class="content2">
		 ...
		 if($yearstart >= '1970' && $yearstart != '1983' && $yearstart != '1971') echo '<a href="tabs.php?pg=0&ind=1&tab=photos&dec=' . $decade . '&yea=' . $year . '" target="inline" title="Click Here for More Photos of this Year!">';
		 echo '<img src="photos/group/dollie-' . $groupimage . '.jpg" border="0"><br>';  
		 if($yearstart >= '1970' && $yearstart != '1983' && $yearstart != '1971') echo '</a>';
